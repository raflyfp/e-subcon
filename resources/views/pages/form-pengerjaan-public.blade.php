...
<body>
            ...
            <div>
                ...
                @else
                    <a href="{{ route('login') }}" class="btn btn-outline-primary btn-sm px-3 fw-semibold">
                        <i class="ti ti-lock me-1"></i> Login
                    </a>
                @endif
            </div>
        </div>
        ...
        @else
            ...
            <div class="gf-card gf-header-card">
                ...
                <p class="text-muted mb-3">
                    Silakan isi dan pilih nama karyawan, barang, dan lokasi, lalu masukkan jumlah pengerjaan.
                </p>
            ...
            <form method="POST" action="{{ route('pengerjaan.store-public') }}" id="publicPengerjaanForm">
                ...
                <div class="gf-card">
                    ...
                    <select class="form-select select2-search" name="karyawan_id" id="karyawan_id"
                        data-placeholder="-- Cari Nama atau Nomor Karyawan --" required>
                        <option value=""></option>
                ...
                <div class="gf-card">
                    ...
                    <select class="form-select select2-search" name="barang_id" id="barang_id"
                        data-placeholder="-- Cari Kode atau Nama Barang --" required>
                        <option value=""></option>
                        @foreach ($barangList as $b)
                            <option value="{{ $b->id }}" data-kode="{{ $b->kode_barang }}"
                                data-nama="{{ $b->nama_barang }}" {{ old('barang_id') == $b->id ? 'selected' : '' }}>
                ...
                <div class="gf-card">
                    ...
                    <select class="form-select select2-search" name="lokasi_subcon_id" id="lokasi_subcon_id"
                        data-placeholder="-- Pilih / Cari Lokasi Subcon --" required>
                        <option value=""></option>
                ...
                {{-- 4. Tanggal Pengerjaan (Readonly / Disabled) --}}
                <div class="gf-card">
                    <label class="form-label" for="tanggal">
                        4. Tanggal Pengerjaan <span class="text-danger">*</span>
                    </label>
                    <div class="form-help">Tanggal pengerjaan otomatis terisi hari ini:</div>
                ...
                {{-- 5. Jumlah Selesai (Simple Input) --}}
                <div class="gf-card">
                    <label class="form-label" for="jumlah">
                        5. Jumlah Barang Selesai (Unit) <span class="text-danger">*</span>
                    </label>
                    <div class="form-help">Masukkan kuantitas unit produk yang berhasil diselesaikan:</div>

                    <div class="input-group input-group-lg">
                        <input type="number" class="form-control form-control-lg" name="jumlah" id="jumlah"
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <button type="reset" class="btn btn-link text-secondary text-decoration-none"
                        onclick="resetForm()">
                        Kosongkan formulir
                    </button>
                </div>
    ...
    <script>
        $(document).ready(function() {
            // Inisialisasi Select2: Harus ketik search dulu baru muncul dropdown pilihannya
            ...
            // Fokus otomatis ke kolom pencarian saat diklik
