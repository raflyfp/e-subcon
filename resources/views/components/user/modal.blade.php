<div class="modal fade" id="tambah_user" tabindex="-1" aria-labelledby="modalTambahUserLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content border-0 shadow">
            <div class="modal-header bg-primary text-white py-3 px-4">
                <h5 class="modal-title text-white fw-bold d-flex align-items-center" id="modalTambahUserLabel">
                    <i class="ti ti-user-plus fs-4 me-2"></i> Tambah User & Atur Hak Akses
                </h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form method="POST" action="{{ route('user.simpan') }}" id="formTambahUser">
                @csrf
                        ...
                        <div class="card-body p-3">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="username" placeholder="Contoh: ppic_admin" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold text-dark mb-1">Password <span class="text-danger">*</span></label>
                                    <input type="password" class="form-control" name="password" placeholder="Minimal 5 karakter" required minlength="5">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold text-dark mb-1" for="select_role_tambah">Role / Tipe User <span class="text-danger">*</span></label>
                                    <select class="form-select" name="role" id="select_role_tambah" required>
                                        @if (empty($hasSuperAdmin))
                                            <option value="super_admin">Super Admin (Akses Penuh Semua Menu & Aksi)</option>
                                        @else
                                            <option value="super_admin" disabled>Super Admin (Sudah ada - Maks. 1 Akun)</option>
                                        @endif
                                        <option value="admin_ppic">Admin PPIC (Produksi & Monitoring)</option>
                                        <option value="admin_biasa" selected>Admin Biasa (Operasional)</option>
                                        <option value="user">User (Pengguna Biasa)</option>
                                    </select>
                                    <small class="text-muted d-block mt-1" style="font-size: 0.8rem;">
                                        <i class="ti ti-info-circle me-1 text-primary"></i>Untuk membuat akun user <strong>Subcon</strong>, silakan buat melalui menu <strong>Master Lokasi Subcon</strong>.
                                    </small>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card border shadow-none bg-white">
                        <div class="card-header bg-white py-2 px-3 border-bottom d-flex justify-content-between align-items-center flex-wrap gap-2">
                            ...
                            <div class="d-flex gap-2">
                                <button type="button" class="btn btn-outline-primary btn-sm py-1 px-3 fw-semibold" id="btn_select_all_tambah">
                                    <i class="ti ti-check-all me-1"></i> Pilih Semua
                                </button>
                                <button type="button" class="btn btn-outline-secondary btn-sm py-1 px-3 fw-semibold" id="btn_unselect_all_tambah">
                                        ...
                                        <tr class="text-center" style="color: #334155;">
                                            ...
                                            <th style="width: 105px; vertical-align: middle; background-color: #eef2f6 !important; position: sticky; top: 0; z-index: 10; border-bottom: 2px solid #cbd5e1; border-right: 1px solid #e2e8f0; border-top: 1px solid #e2e8f0;" class="py-2">
                                                <div class="d-flex flex-column align-items-center justify-content-center">
                                                    ...
                                                    <input class="form-check-input col-check-tambah mt-0" type="checkbox" data-col="view" title="Pilih Semua Hak Akses">
                                                </div>
                                            </th>
                                            <th style="width: 95px; vertical-align: middle; background-color: #eef2f6 !important; position: sticky; top: 0; z-index: 10; border-bottom: 2px solid #cbd5e1; border-right: 1px solid #e2e8f0; border-top: 1px solid #e2e8f0;" class="py-2">
                                                <div class="d-flex flex-column align-items-center justify-content-center">
                                                    ...
                                                    <input class="form-check-input col-check-tambah mt-0" type="checkbox" data-col="create" title="Pilih Semua Tambah">
                                                </div>
                                            </th>
                                            <th style="width: 95px; vertical-align: middle; background-color: #eef2f6 !important; position: sticky; top: 0; z-index: 10; border-bottom: 2px solid #cbd5e1; border-right: 1px solid #e2e8f0; border-top: 1px solid #e2e8f0;" class="py-2">
                                                <div class="d-flex flex-column align-items-center justify-content-center">
                                                    <span class="fw-bold mb-1">Ubah</span>
                                                    <input class="form-check-input col-check-tambah mt-0" type="checkbox" data-col="edit" title="Pilih Semua Ubah">
                                                </div>
                                            </th>
                                            <th style="width: 95px; vertical-align: middle; background-color: #eef2f6 !important; position: sticky; top: 0; z-index: 10; border-bottom: 2px solid #cbd5e1; border-right: 1px solid #e2e8f0; border-top: 1px solid #e2e8f0;" class="py-2">
                                                <div class="d-flex flex-column align-items-center justify-content-center">
                                                    <span class="fw-bold mb-1">Hapus</span>
                                                    <input class="form-check-input col-check-tambah mt-0" type="checkbox" data-col="delete" title="Pilih Semua Hapus">
                                                </div>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        @foreach ($permissionMatrix as $catName => $modules)
                                            ...
                                            @foreach ($modules as $mod)
                                                <tr class="permission-row-tambah bg-white">
                                                    ...
                                                    <td class="text-center py-2" style="border: 1px solid #e2e8f0;">
                                                        @if (!empty($mod['view']))
                                                            <input class="form-check-input check-permission-tambah perm-view" type="checkbox"
                                                                name="permissions[]" value="{{ $mod['view'] }}"
                                                                id="perm_tambah_{{ str_replace('.', '_', $mod['view']) }}"
                                                    ...
                                                    <td class="text-center py-2" style="border: 1px solid #e2e8f0;">
                                                        @if (!empty($mod['create']))
                                                            <input class="form-check-input check-permission-tambah perm-create" type="checkbox"
                                                                name="permissions[]" value="{{ $mod['create'] }}"
                                                                id="perm_tambah_{{ str_replace('.', '_', $mod['create']) }}"
                                                                style="width: 1.15rem; height: 1.15rem; cursor: pointer;">
                                                        @else
                                                            <span class="text-muted" style="opacity: 0.3;">-</span>
                                                        @endif
                                                    ...
                                                    <td class="text-center py-2" style="border: 1px solid #e2e8f0;">
                                                        @if (!empty($mod['edit']))
                                                            <input class="form-check-input check-permission-tambah perm-edit" type="checkbox"
                                                                name="permissions[]" value="{{ $mod['edit'] }}"
                                                                id="perm_tambah_{{ str_replace('.', '_', $mod['edit']) }}"
                                                                style="width: 1.15rem; height: 1.15rem; cursor: pointer;">
                                                        @else
                                                            <span class="text-muted" style="opacity: 0.3;">-</span>
                                                        @endif
                                                    ...
                                                    <td class="text-center py-2" style="border: 1px solid #e2e8f0;">
                                                        @if (!empty($mod['delete']))
                                                            <input class="form-check-input check-permission-tambah perm-delete" type="checkbox"
                                                                name="permissions[]" value="{{ $mod['delete'] }}"
                                                                id="perm_tambah_{{ str_replace('.', '_', $mod['delete']) }}"
                                                                style="width: 1.15rem; height: 1.15rem; cursor: pointer;">
                                                        @else
                                                            <span class="text-muted" style="opacity: 0.3;">-</span>
                                                        @endif
